    ...
    [
      ...
      },
      {
        ...
        rules : {
          ...
          3 : "IPO allocation will be visible on the first day of actual trading and will be done on first come first serve basis. So keep an eye on our social media handles for constant updates.",
          4 : "As soon as the market opens at 9:00 AM on the first day, participant can see all the stocks along woth their listing price.",
          5 : "The market will be up from 9:00 AM to 5:00 PM for 3 days.This period is defined as 'day' henceforth in the document.",
          6 : "Any buy bid or sell ask can be made within a margin of ±10% of the current share price.For ex,if the current market price of a share is Rs.100/-,a buy or sell bid can be made from any range between Rs. 90- Rs.110/-",
          7 : "A transaction fee of 1% of total transaction cost will be charged from both the seller and the buyer for every successful transaction between the two.",
          8 : "When a user places a buy bid for the shares of the compay A, the amount he's bidding for will be immedialtely deducted from his account along with the relevant transaction fee of 1%. For ex. if the buyer buys 50 shares for Rs. 106 each share, the cost will be Rs.5300/-. Adding 1% transaction fee the final cost that'll be deducted from the buyer's account will be1.01*5300 = Rs.5353/-. This amount will be immediately deducted, and the user won't be able to access this amount.",
